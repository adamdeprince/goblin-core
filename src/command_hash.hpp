  ...
  static const unsigned char asso_values[] =
    {
      ...
      108, 108, 108, 108, 108, 108, 108, 108, 108, 108,
      108, 108, 108, 108, 108, 108, 108, 108, 108, 108,
      108, 108, 108, 108, 108,  30, 108,  45,  25,   5,
      108,   5,   0,  20, 108,   5,  10,  43,   0,   0,
        0, 108,  55,   0,   0,  35,  55,  10,  61,  10,
...
CommandDispatch::lookup (const char *str, size_t len)
{
  static const unsigned char lengthtable[] =
    {
       0,  0,  0,  0,  4,  0,  6,  7,  3,  4,  5,  6,  7,  3,
       4,  0,  6,  0,  8,  4,  0, 11,  7,  8,  4, 15,  6,  0,
      13,  4,  0, 11,  0,  0,  0,  0,  6,  7,  0,  4,  0, 11,
       0,  3,  0,  0,  6,  4,  5, 14,  0,  6,  4,  0,  4, 10,
      11, 12,  0,  4,  5,  6,  0,  8,  9,  5,  6,  6,  8,  9,
       0,  5,  6,  0,  4,  5, 11,  0,  0,  4, 15,  0,  0,  0,
       9,  0, 11, 12,  0,  4,  0,  0,  0,  0,  0,  0,  0,  7,
