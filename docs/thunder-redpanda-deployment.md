# Thunder and Redpanda durability deployment record
...
million final reads. See
[the first external-logging test](../EXTERNAL-LOGGING-FIRST-TEST.md) and
[the all-types external-logging test](../EXTERNAL-LOGGING-ALL-TYPES-TEST.md).
...
[the primary/replica recovery test](../EXTERNAL-LOGGING-PRIMARY-REPLICA-TEST.md).
